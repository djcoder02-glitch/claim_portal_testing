...
import { VASReport } from "@/hooks/useVASReports";

interface VASReportsTableProps {
  reports: VASReport[];
}
...
export const VASReportsTable = ({ reports }: VASReportsTableProps) => {
                ...
                filteredAndSortedReports.map((report) => (
                  <TableRow key={report.id}>
                    <TableCell className="font-medium">
                      <Link 
                        to={`/value-added-services/reports/${report.id}`}
